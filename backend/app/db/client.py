...
async def ensure_indexes(db: AsyncIOMotorDatabase) -> None:
    try:
        ...
        await db.reviews.create_index([("booking_id", 1), ("reviewer_id", 1), ("review_type", 1)], unique=True)
...
async def connect_db():
    ...
    try:
        ...
        logger.warning("MongoDB unavailable; API requests will be rejected until connectivity is restored: %s", exc)
